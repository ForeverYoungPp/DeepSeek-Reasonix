...
const help: SlashHandler = () => ({
  info: [
    ...
    "  fast   v4-flash · effort=high          cheapest · quick Q&A, one-line edits",
    "  smart  v4-flash · effort=max           ← default · day-to-day coding",
    "  max    v4-pro   · effort=max           ~12× fast · hard single-shots",
    "",
